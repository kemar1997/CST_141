...
public class Project10 extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        String[] pi = new String[] {"-3\u03c0", "-2\u03c0", "-\u03c0", "0" ,
            "\u03c0", "2\u03c0", "3\u03c0"};
        ...
        for (int x = -170; x <= 170; x++) {
            ...
            if (y >= 99.9 && y < 100.01) {
                Text text1 = new Text(x + CENTER_X, CENTER_Y / 0.9, 
                        pi[index++]);
        ...
        primaryStage.setTitle("Ball on a curve animation");
    ...
    private static void drawXAxis(Pane pane, Polyline xAxis) {
        ...
        Line line1 = new Line(limit, CENTER_Y,
                limit - WIDTH * 0.05, CENTER_Y * 0.875);
        Line line2 = new Line(limit, CENTER_Y,
                limit - WIDTH * 0.05, CENTER_Y / 0.875);
    ...
    private static void drawYAxis(Pane pane, Polyline yAxis) {
        ...
        Line line1 = new Line(CENTER_X, HEIGHT * 0.1, 
                CENTER_X - WIDTH * 0.05, HEIGHT * 0.2);
        Line line2 = new Line(CENTER_X, HEIGHT * 0.1, 
                CENTER_X + WIDTH * 0.05, HEIGHT * 0.2);
