...
// This class is known as an abstract class (which means an object is never instantiated from it)
public class PayrollCheck extends Object
{
    ...
    /** Returns formatted checkNumber and employeeID fields including text 
     *  labels.
     *  
     *  @return Formatted check number and employee ID number fields as type String.
     */
